...
f=figure('OuterPosition',[x1,y1,width,4*height]);
...
oxd=permute(m1.dwdyn-m1.dvdzn,[2 1 3]);
oyd=permute(m1.dudzn-m1.dwdxn,[2 1 3]);
ozd=permute(m1.dvdxn-m1.dudyn,[2 1 3]);
ld=permute(m1.lambda2n,[2 1 3]);
oxu=permute(m2.dwdyn-m2.dvdzn,[2 1 3]);
oyu=permute(m2.dudzn-m2.dwdxn,[2 1 3]);
ozu=permute(m2.dvdxn-m2.dudyn,[2 1 3]);
lu=permute(m2.lambda2n,[2 1 3]);
...
% saveas(f,'iso_lines_retro_compiled.fig')