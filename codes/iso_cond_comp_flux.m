...
interpColors = interp3(z, x, y, -nld./ut^2,...wd.*0, ...interpColors = interp3(z, x, y, -nld./ut^2,...wd.*0, ...
    isosurf.vertices(:, 1), ...
    isosurf.vertices(:, 2), ...
    isosurf.vertices(:, 3));
...
if j==5
 c=colorbar;
 ylabel(c,"$\langle  v\omega_z-w\omega_y\rangle_+/(-u_{\tau}^2/H)$",'interpreter','latex','FontSize',11)
...
interpColors = interp3(z, x, y, -nlu./ut^2,...wd.*0, ...interpColors = interp3(z, x, y, -nld./ut^2,...wd.*0, ...
    isosurf.vertices(:, 1), ...
    isosurf.vertices(:, 2), ...
    isosurf.vertices(:, 3));
