...
%% average_bottom_split_allvars.m
close all;
clear;

%% 1. Parameters (Must match calc_conditionaln.m)
...
event_file = sprintf("../data/conditionaln_jcond_1_%03d.mat", jcond);
...
for t = 1:length(unique_times)
    ...
    % Filter for bottom half
    is_bottom = (events_t(:,3) == jcond);
    events_bot = events_t(is_bottom, :);
...
fc = sprintf("../data/conditional_bottom_split_allvars_jcond_%03d.mat", jcond);
